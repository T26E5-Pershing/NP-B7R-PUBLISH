...
ghost-respawn-minutes-left = Before the opportunity to return to the round { $time } minutes
    { $time ->
        [one] minute
       *[other] minutes
    }
ghost-respawn-seconds-left = Before the opportunity to return to the round { $time } seconds
    { $time ->
        [one] second
       *[other] seconds
    }
ghost-respawn-success = Respawn successful
...
ghost-respawn-same-character-slightly-changed-name = You cannot enter the round with a nearly identical character name. Change it in the character settings.
